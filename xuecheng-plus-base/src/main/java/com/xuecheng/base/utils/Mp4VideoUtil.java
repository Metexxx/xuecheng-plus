...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\ffmpeg-master-latest-win64-gpl-shared\\bin\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "D:\\ffmpeg-master-latest-win64-gpl-shared\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\develop_tools\\upload\\bigfile_test\\lalala.mkv";
        //转换后mp4文件的名称
        String mp4_name = "video_new.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\develop_tools\\upload\\bigfile_test\\" + mp4_name;
        //创建工具类对象
